...
CSRF_TRUSTED_ORIGINS = os.getenv("DJANGO_CSRF_TRUSTED_ORIGINS", "http://127.0.0.1:8000,http://localhost:8000,http://0.0.0.0:8000,http://0.0.0.0:50000,http://127.0.0.1,http://localhost").split(",")
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("POSTGRES_DB", "bedrock"),
        "USER": os.getenv("POSTGRES_USER", "bedrock"),
        "PASSWORD": os.getenv("POSTGRES_PASSWORD", "bedrock"),
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Bedrock API",
    "DESCRIPTION": "Internal novel creation and review platform",
    "VERSION": "0.1.0",
}
